...
def main(arglist=None):
    ...
    try:
        rprint(f"Accessing '{g.get_user().html_url}'.")
    except BadCredentialsException:
        rprint(
            "\n[bright_red]ERROR: Credentials not accepted.\n\nHas the personal access "
